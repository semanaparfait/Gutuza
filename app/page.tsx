...
export default function Home() {
  ...
  const [liveAssetsError, setLiveAssetsError] = React.useState<string | null>(
    null,
  );
  ...
  const [priceFilterTouched, setPriceFilterTouched] =
  ...
  const [chatContext, setChatContext] = React.useState<ChatContext | null>(
    null,
  );
  ...
  const filteredAssets = assets.filter((ast) => {
    ...
    if (locationFilter.trim()) {
      ...
      const matchLoc =
        ast.location.toLowerCase().includes(loc) ||
        ast.country.toLowerCase().includes(loc);
      ...
      <main className="flex-1">
        <div>
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
            ...
            {/* Filter Controls Bar */}
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 p-4  rounded-2xl border border-slate-200  shadow-sm">
              {/* Result Counter & Active Pill */}
              <div className="flex items-center gap-3">
                <span className="text-sm font-bold text-slate-900 ">
                  Showing{" "}
                  <span className="  font-extrabold text-[#2BB673]">
              ...
              <div className="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end">
                ...
                <div className="hidden sm:flex items-center gap-2 text-xs">
                  ...
                  <input
                    ...
                    step={Math.max(
                      50,
                      Math.round(priceCeiling / 100 / 50) * 50,
                    )}
                    value={maxPrice}
                    onChange={(e) => {
            ...
            {viewMode === "map" ? (
              ...
              <div className="relative w-full h-[550px] bg-[#111a18] rounded-3xl border border-slate-800 overflow-hidden flex items-center justify-center p-6 text-white text-center">
                ...
                <div className="relative z-10 max-w-md space-y-4">
                  ...
                  <h3 className="text-2xl font-black font-display">
                    Interactive Geospatial Asset Radar
                  </h3>
                  <p className="text-xs text-slate-300">
                    Locate active Caterpillar excavators, John Deere tractors,
                    cold storage facilities, and fleet trucks pinned across
                    Kigali, Musanze, and regional hubs.
                  </p>
              ...
              <div className="text-center py-20 bg-white dark:bg-[#192724] rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4">
                ...
                <p className="text-xs text-slate-500 max-w-sm mx-auto">
                  Try adjusting your filters, clearing keywords, or selecting a
                  broader category.
                </p>
                <button
                  onClick={() => {
      ...
      <footer className="bg-brand-900 text-slate-400 border-t border-slate-800 text-xs py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-3">
              ...
              <p className="text-slate-400 leading-relaxed">
                Empowering individuals, farmers, and business owners across
                Africa to monetize underutilized machinery, land, and tools.
              </p>
            </div>
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    ...
                    className="hover:text-brand-400 transition-colors"
                  >
                    Assetify Bank Escrow Protection
                  </a>
                </li>
                <li>
                  <a
          ...
          <div className="pt-8 border-t border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] text-slate-500">
            <p>
              © {new Date().getFullYear()} Assetify Digital Marketplace. All
              rights reserved.
            </p>
