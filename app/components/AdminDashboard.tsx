      ...
      <div className="p-6 bg-[#111a18] text-white rounded-3xl border border-slate-800 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">
            Platform oversight, host verification, escrow protection, and asset
            compliance.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <button
            onClick={() => router.push("/")}
            className="flex items-center gap-2 px-3 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-bold rounded-xl border border-slate-700"
          >
      ...
      <div className="bg-white dark:bg-[#192724] rounded-3xl border border-slate-200 dark:border-slate-800 p-6 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-amber-600 font-semibold">
            {verifications.filter((v) => v.status === "Pending Review").length}{" "}
            Pending Requests
          </span>
        </div>
            ...
            >
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2 text-xs text-slate-500">
                  ...
                  <span>
                    {v.document} • Submitted {v.submittedDate}
                  </span>
                </div>
              </div>
